...
<div class="w3-row">
  ...
  <a href="/html/default.asp" class="w3-btn sectionbtn">LEARN HTML</a>
  <a href="/tags/default.asp" class="w3-btn sectionbtn">HTML REFERENCE</a>
  </div>
  <div class="w3-col l6 section sectionexample">
    ...
    <a href="/html/tryit.asp?filename=tryhtml_default" target="_blank" class="w3-btn w3-theme">Try it Yourself</a>
    </div>
  </div>
</div>
<div class="w3-row w3-light-grey">
  ...
  <a href="/css/default.asp" class="w3-btn sectionbtn">LEARN CSS</a>
  <a href="/cssref/default.asp" class="w3-btn sectionbtn">CSS REFERENCE</a>  
  </div>
  ...
  <a href="/css/tryit.asp?filename=trycss_default" target="_blank" class="w3-btn w3-theme">Try it Yourself</a>
  </div>
...
<div class="w3-row">
  ...
  <a href="/js/default.asp" class="w3-btn sectionbtn">LEARN JAVASCRIPT</a>
  <a href="/jsref/default.asp" class="w3-btn sectionbtn">JAVASCRIPT REFERENCE</a>  
  </div>
  <div class="w3-col l6 section sectionexample">
    <div class="w3-example w3-padding-16 w3-margin-0">
    ...
    <a href="/js/tryit.asp?filename=tryjs_default" target="_blank" class="w3-btn w3-theme">Try it Yourself</a>
    </div>
  </div>
</div>
<div class="w3-row w3-light-grey">
  ...
  <a href="/sql/default.asp" class="w3-btn sectionbtn">LEARN SQL</a>
  </div>
  </div>
  <div class="w3-col l4 w3-center section onethird">
  <div class="w3-card-2 w3-white">
  ...
  <a href="/php/default.asp" class="w3-btn sectionbtn">LEARN PHP</a>
  </div>
  </div>
  <div class="w3-col l4 w3-center section onethird">
  <div class="w3-card-2 w3-white">
  ...
  <a href="/jquery/default.asp" class="w3-btn sectionbtn">LEARN JQUERY</a>
  </div>
  </div>
</div>
<div class="w3-row">
  <div class="w3-col l4 w3-center section onethird">
  <h2>W3.CSS</h2>
  <p class="w3-large">CSS for fast and beautiful responsive web sites inspired by material design</p>
  <a href="/w3css/default.asp" class="w3-btn sectionbtn">LEARN W3.CSS</a>
  </div>
  <div class="w3-col l4 w3-center section onethird">
  <h2>Color Picker</h2>
  <a href="/tags/ref_colorpicker.asp"><img style="width:150px;height:128px;" src="/images/colorpicker.png"></a>
  </div>
  <div class="w3-col l4 w3-center section onethird">
  <h2>Bootstrap</h2>
  <p class="w3-large">Bootstrap is a CSS framework for designing better web pages</p>
  <a href="/bootstrap/default.asp" class="w3-btn sectionbtn">LEARN BOOTSTRAP</a>
  </div>
</div>
<br>
<footer class="w3-container w3-light-grey w3-center w3-padding-jumbo w3-text-black-opacity">
  <a href="/cert/default.asp"><button class="w3-btn w3-dark-grey">WEB CERTIFICATES</button></a>
  <br>
  <nav class="about">
